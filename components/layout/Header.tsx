...
export default function Header() {
    ...
    return (
        <header className="fixed top-0 left-0 z-[9997] h-auto w-full pointer-events-none bg-gradient-to-b from-[hsla(30,62%,98%,0.7)] to-transparent transition-shadow duration-200 ease-linear">
