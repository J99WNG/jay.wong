    ...
    return (
        <footer className="h-fit md:h-16" aria-label="Footer">
            ...
            <div id="footer-wrapper" className="flex flex-col items-center gap-4 py-4 px-0 md:flex-row md:justify-between">
                ...
                <p className="footer-copy text-sm text-[var(--ceylon-leaf)] text-center m-0 md:text-left">
                    © {currentYear} Jay Wong. Built by me + a bit of ai.
                </p>

                <nav className="footer-social flex gap-4 justify-end" aria-label="Social media">
                    <a href="https://linkedin.com/in/jayycwong" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                        {/* LinkedIn icon */}
                        <span className="icon icon-md text-[var(--ceylon-leaf)]">
                    ...
                    <a href="https://x.com/J99WNG" target="_blank" rel="noopener noreferrer" aria-label="X (Twitter)">
                    {/* X icon */}
                    <span className="icon icon-md text-[var(--ceylon-leaf)]">
                    ...
                    <a href="https://instagram.com/J99WNG" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                    {/* Instagram icon */}
                    <span className="icon icon-md text-[var(--ceylon-leaf)]">
