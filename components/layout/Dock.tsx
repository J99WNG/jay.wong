...
export default function Dock() {
  ...
  return (
    <div 
      ref={dockRef} 
      id="dock-wrapper"
      className="fixed bottom-0 left-1/2 -translate-x-1/2 translate-y-full w-full h-16 flex items-center justify-center z-[9998] pointer-events-none bg-gradient-to-t from-bg-primary/70 to-transparent transition-all duration-200 ease-linear"
    >
      <Button 
        variant="primary" 
