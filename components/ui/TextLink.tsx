...
export default function TextLink({ href, children, className = '', external }: TextLinkProps) {
  ...
  const linkClasses = `group relative inline-flex items-center w-fit text-[var(--color-blue-500)] hover:text-[var(--color-blue-300)] transition-colors duration-200 tracking-[-0.04rem] ${className}`;
