    ...
    <GalleryProvider>
      <article>
        ...
        <Section id="selected-work">
          <div className="col-30-70">
            <div className="section-heading">
              <h2>Selected work<br /><span className="section-subheading">Personality, made reusable.</span></h2>
            </div>
        ...
        <Section id="reflection">
          <div className="col-30-70">
            <div className="section-heading">
              <h2>Reflection<br /><span className="section-subheading">Too much change, too soon.</span></h2>
            </div>
            <div className="section-content">
              <div className="content-block">
